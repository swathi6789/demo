...
function education(edu){
	...
	eduTable.border="1";
	var tr1="<tr><td>Degree</td><td>Institute</td><td>Data</td><td>marks</td></tr>";
	eduTable.innerHTML=tr1;
	var tr2="";
	for(var i=0;i<edu.length;i++){
		tr2+="<tr><td>"+edu[i].degree+"</td><td>"+edu[i].institute+"</td><td>"+edu[i].data+"</td><td>"+edu[i].marks+"</td></tr>";
